              ...
              {isUserLogin && (
                <>
                  <div className="bg-white dark:bg-zinc-800 p-4 rounded">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">
                      Username: <code className="bg-zinc-200 dark:bg-zinc-700 px-1 rounded">ajohnson</code>
                    </p>
                    <p className="text-zinc-600 dark:text-zinc-400">
                  ...
                  <div className="bg-white dark:bg-zinc-800 p-4 rounded">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">
                      Email: <code className="bg-zinc-200 dark:bg-zinc-700 px-1 rounded">jane.smith@example.com</code>
                    </p>
                    <p className="text-zinc-600 dark:text-zinc-400">
                      Username: <code className="bg-zinc-200 dark:bg-zinc-700 px-1 rounded">jsmith</code>
                    </p>
                    <p className="text-zinc-600 dark:text-zinc-400">
                      Password: <code className="bg-zinc-200 dark:bg-zinc-700 px-1 rounded">password123!</code>
                    </p>
                  ...
                  <div className="bg-white dark:bg-zinc-800 p-4 rounded">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">
                      Username: <code className="bg-zinc-200 dark:bg-zinc-700 px-1 rounded">jdoe</code>
                    </p>
                    <p className="text-zinc-600 dark:text-zinc-400">
                      Password: <code className="bg-zinc-200 dark:bg-zinc-700 px-1 rounded">password123!</code>
                    </p>
