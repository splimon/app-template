    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {user.org && (
            <Badge variant="outline" className="text-sm">{user.org.name}</Badge>
          )}
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium">{user.org?.name || 'N/A'}</p>
            </div>
            <div>
              <span className="text-muted-foreground">Organization Slug:</span>
              <p className="font-mono">{user.org?.slug || 'N/A'}</p>
            </div>
            <div>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium">Manage Your Organization(s)</h4>
                <p className="text-xs text-muted-foreground">Be an admin to one or more organizations</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-muted-foreground">Manage All Organizations</h4>
                <p className="text-xs text-muted-foreground">Requires system admin privileges</p>
              </div>
            </div>
          </div>
        </CardContent>
